...
from planning_utils_probabilistic import a_star, heuristic, create_graph, prune_path
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        if READ_FROM_FILE:
            print("Warning, will load graph from file.")
            with open(GRAPH_FILENAME, "rb") as file:
                graph, _, _ = pickle.load(file)
        else:
            # Read in obstacle map.
            data = np.loadtxt(INPUT_DATA_FILE, delimiter=",", dtype="Float64", skiprows=2)
        ...
        print("Local Start and Goal: {}, {}.".format(graph_start, graph_goal))
